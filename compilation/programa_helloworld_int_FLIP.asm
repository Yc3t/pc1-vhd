		...
		DISABLE INTERRUPT
start:		CALL		recibe
		CALL		long_delay	; half-second pause so terminal is ready
...
;----------------------------------------------------------
;   Routine: long_delay   ≈ 0.5 s  (clk = 50 MHz)
;   Uses cont1 (S4) and cont2 (S5)
;   Outer loop = 255, inner loop = 250
;   255 × 250 × 8 µs ≈ 0.51 s
;----------------------------------------------------------
long_delay:
	LOAD		cont1, FF	; outer loop counter = 255
delay_outer:
	LOAD		cont2, FA	; inner loop counter = 250
delay_inner:
	SUB		cont2, 01
	JUMP		NZ, delay_inner
	SUB		cont1, 01
	...
	RETURN
        	...
        	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
		;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        	; RUTINA DE ATENCION A LA INTERRUPCI�N
        	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
